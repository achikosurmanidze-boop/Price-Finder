...
class IliScraper(BaseScraper):
    store_name = "Ili"
    base_url = "https://ili.ge"
    search_url = "https://ili.ge/search"
    ...
    def _search(self, query: str) -> list[ProductResult]:
        ...
        cards = soup.select(".product, .product-card, .item, .pharmacy-item, [class*='product']")
