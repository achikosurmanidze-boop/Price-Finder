...
class PspScraper(BaseScraper):
    store_name = "PSP"
    base_url = "https://psp.ge"
    search_url = "https://psp.ge/search"
    ...
    def _search(self, query: str) -> list[ProductResult]:
        ...
        cards = soup.select(".product, .product-card, .item, [class*='product']")
